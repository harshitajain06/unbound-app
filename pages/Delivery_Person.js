...
<section 
       style={{
        ...
        <div className="w-full md:pl-72">
          <h1 className="text-4xl md:text-4xl font-bold mb-4 text-lime-200 text-center md:-mt-32 mt-16">ext-center md:-mt-32 mt-16">ext-center md:-mt-32 mt-16">ext-center md:-mt-32 mt-16">
            DELIVERY PERSON{" "}
          </h1>
