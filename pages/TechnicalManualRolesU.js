  ...
  return (
    <Layout TechnicalManualRolesU>
      ...
      <section className="flex flex-col items-center justify-center w-full h-full">
        ...
        <a href={"/Car_R_Tech"}>
          <button className="text-cyan-200 text-xl font-serif h-8  mt-7 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 ...">
        ...
        <a href={"/Manufacturing_Operator"}>
          <button className="text-lime-200 text-xl font-serif mt-7 transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-150 duration-300 ...">
            <p className="text-lime-200">Manufacturing Operator</p>
          </button>
        </a>
