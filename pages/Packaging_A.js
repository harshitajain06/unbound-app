...
//   const router = useRouter(); // Fixed: Added missing declaration for useRouter
...
//           <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-4 text-lime-200">
//             PACKAGING ASSISTANT
//           </h1>
//           <h2 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 text-green-200 mb-8">
//             DESCRIPTION
//           </h2>

//           <div className="text-left">
//             <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-4 text-amber-300 ">
//               Job Overview
//             </h3>
...
//             <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-4 text-green-300 ">
//               Basic Salary
//             </h3>
//             <p className="text-white mb-8 leading-relaxed text-balance">
//               Entry-level packaging assistants earn around INR 8,000 to INR
...
//             <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-4 text-cyan-400 ">
//               Time Consumption
//             </h3>
//             <p className="text-white mb-8 leading-relaxed text-balance">
//               Full-time work, typically 8-10 hours per day, may involve
...
//             <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-4 text-yellow-100 ">
//               Basic Knowledge
//             </h3>
//             <p className="text-white mb-8 leading-relaxed text-balance">
//               *{" "}
...
//             <h3 className="text-lg md:text-xl lg:text-2xl font-bold mb-4 text-cyan-200">
//               Best Places to Work
//             </h3>
//             <p className="text-white mb-8 leading-relaxed text-balance">
//               *{" "}
