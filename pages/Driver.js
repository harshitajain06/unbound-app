        ...
        <div className="conta15ner mx-auto text-center md:w-2/3 lg:w-1/2">
          ...
          <div className="text-left">
            <h3 className="text-4xl md:text-lg font-bold mb-4 text-amber-300 ">
              ...
              Drivers in India operate vehicles to transport goods or passengers, ensuring 
            ...
            <h3 className="text-4xl md:text-lg font-bold mb-4 text-green-300">
              Basic Salary
              <p className="text-white mb-8 text-sm leading-relaxed text-wrap ... text-balance ...">
              Entry-level drivers earn around INR 12,000 to INR 20,000 per month, varying
               by the type of vehicle and employer.
            ...
            <h3 className="text-4xl md:text-lg font-bold mb-4 text-cyan-400">
              Time Consumption
              <p className="text-white mb-8 text-sm leading-relaxed text-wrap ... text-balance ...">
              Full-time work, typically 8-12 hours per day, may involve irregular
               hours or long-distance travel.
