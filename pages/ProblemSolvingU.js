...
export default function ProblemSolvingU() {
  ...
  const ProblemSolvingUOptions = [
    { label: "Operations and Labor Roles", value: "Operations and Labor Roles" },
    { label: "Administrative and Service Roles", value: "Administrative and Service Roles" },
    
  ];

  const handleSubmit = () => {
    if (dropdownValue === "Operations and Labor Roles") {
      router.push("/OperationsLaborRolesU");
    } else if (dropdownValue === "Administrative and Service Roles") {
      router.push("/AdministrativeServiceRolesU");
    }
  };
